...
@Autonomous(name = "Red FoundationAuto_Pro_Max_IMU", group = "Linear Opmode")
public class Red_Foundation_Pro_Max_IMU extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sleep(1100);
        //m_electricBot.m_drive.setStrafeHeading(180, 0.25, 700);
        //sleep(500);
        m_electricBot.m_drive.setDriveEncoders(-90, -0.85, 75, true);
        m_electricBot.m_drive.setStrafeHeading(180, 0.1, 500);
    }
}
